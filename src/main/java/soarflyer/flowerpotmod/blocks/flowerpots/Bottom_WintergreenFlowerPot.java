...
public class Bottom_WintergreenFlowerPot extends Block {
	public Bottom_WintergreenFlowerPot(String key, int id) {
		super(key, id, Material.dirt);

	}

	/// Change this when making new blocks
	int ChangeID = BlockID + ID_Wintergreen;
	int ChangeTopID = BlockID + ID_Wintergreen + 1;
