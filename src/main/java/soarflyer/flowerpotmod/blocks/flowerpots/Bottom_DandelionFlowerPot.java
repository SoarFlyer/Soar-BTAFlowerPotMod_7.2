...
public class Bottom_DandelionFlowerPot extends Block {
	public Bottom_DandelionFlowerPot(String key, int id) {
		super(key, id, Material.dirt);

	}

	/// Change this when making new blocks
	int ChangeID = BlockID + ID_Dandelion;
	int ChangeTopID = BlockID + ID_Dandelion + 1;
