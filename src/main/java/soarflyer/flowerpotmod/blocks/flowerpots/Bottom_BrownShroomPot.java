...
public class Bottom_BrownShroomPot extends Block {
	public Bottom_BrownShroomPot(String key, int id) {
		super(key, id, Material.dirt);

	}

	/// Change this when making new blocks
	int ChangeID = BlockID + ID_BrownShroom;
	int ChangeTopID = BlockID + ID_BrownShroom + 1;
