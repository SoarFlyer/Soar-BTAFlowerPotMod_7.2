...
public class Bottom_RetroTreePot extends Block {
	public Bottom_RetroTreePot(String key, int id) {
		super(key, id, Material.dirt);

	}

	/// Change this when making new blocks
	int ChangeID = BlockID + ID_Retro;
	int ChangeTopID = BlockID + ID_Retro + 1;
