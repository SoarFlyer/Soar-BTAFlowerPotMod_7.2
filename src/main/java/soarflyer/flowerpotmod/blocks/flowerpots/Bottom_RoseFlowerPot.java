...
public class Bottom_RoseFlowerPot extends Block {
	public Bottom_RoseFlowerPot(String key, int id) {
		super(key, id, Material.dirt);

	}

	/// Change this when making new blocks
	int ChangeID = BlockID + ID_Rose;
	int ChangeTopID = BlockID + ID_Rose + 1;
