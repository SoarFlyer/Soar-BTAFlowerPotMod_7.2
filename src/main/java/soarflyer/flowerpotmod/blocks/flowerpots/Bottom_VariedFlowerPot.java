...
public class Bottom_VariedFlowerPot extends Block {
	public Bottom_VariedFlowerPot(String key, int id) {
		super(key, id, Material.dirt);

	}

	/// Change this when making new blocks
	int ChangeID = BlockID + ID_Varied;
	int ChangeTopID = BlockID + ID_Varied + 1;
