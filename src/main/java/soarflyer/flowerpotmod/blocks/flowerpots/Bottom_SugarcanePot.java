...
public class Bottom_SugarcanePot extends Block {
	public Bottom_SugarcanePot(String key, int id) {
		super(key, id, Material.dirt);

	}

	/// Change this when making new blocks
	int ChangeID = BlockID + ID_Sugarcane;
	int ChangeTopID = BlockID + ID_Sugarcane + 1;
