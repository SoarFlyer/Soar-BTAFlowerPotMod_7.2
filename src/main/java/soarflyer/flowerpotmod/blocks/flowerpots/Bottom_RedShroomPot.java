...
public class Bottom_RedShroomPot extends Block {
	public Bottom_RedShroomPot(String key, int id) {
		super(key, id, Material.dirt);

	}

	/// Change this when making new blocks
	int ChangeID = BlockID + ID_RedShroom;
	int ChangeTopID = BlockID + ID_RedShroom + 1;
