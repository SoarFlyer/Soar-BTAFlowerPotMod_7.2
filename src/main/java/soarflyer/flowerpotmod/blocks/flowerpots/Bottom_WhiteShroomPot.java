...
public class Bottom_WhiteShroomPot extends Block {
	public Bottom_WhiteShroomPot(String key, int id) {
		super(key, id, Material.dirt);

	}

	/// Change this when making new blocks
	int ChangeID = BlockID + ID_WhiteShroom;
	int ChangeTopID = BlockID + ID_WhiteShroom + 1;
