...
public class Bottom_MossyTreePot extends Block {
	public Bottom_MossyTreePot(String key, int id) {
		super(key, id, Material.dirt);

	}

	/// Change this when making new blocks
	int ChangeID = BlockID + ID_Mossy;
	int ChangeTopID = BlockID + ID_Mossy + 1;
