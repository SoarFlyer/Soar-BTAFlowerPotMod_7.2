...
public class Bottom_SpinifexPot extends Block {
	public Bottom_SpinifexPot(String key, int id) {
		super(key, id, Material.dirt);

	}

	/// Change this when making new blocks
	int ChangeID = BlockID + ID_Spinifex;
	int ChangeTopID = BlockID + ID_Spinifex + 1;
