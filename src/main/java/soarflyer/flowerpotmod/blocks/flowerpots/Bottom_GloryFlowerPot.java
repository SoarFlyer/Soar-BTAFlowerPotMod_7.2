...
public class Bottom_GloryFlowerPot extends Block {
	public Bottom_GloryFlowerPot(String key, int id) {
		super(key, id, Material.dirt);

	}

	/// Change this when making new blocks
	int ChangeID = BlockID + ID_Glory;
	int ChangeTopID = BlockID + ID_Glory + 1;
