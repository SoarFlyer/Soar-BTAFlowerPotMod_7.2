...
public class Bottom_BluebellFlowerPot extends Block {
	public Bottom_BluebellFlowerPot(String key, int id) {
		super(key, id, Material.dirt);

	}

	/// Change this when making new blocks
	int ChangeID = BlockID + ID_Bluebell;
	int ChangeTopID = BlockID + ID_Bluebell + 1;
