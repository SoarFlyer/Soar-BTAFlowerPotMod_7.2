...
public class Bottom_ShrubTreePot extends Block {
	public Bottom_ShrubTreePot(String key, int id) {
		super(key, id, Material.dirt);

	}

	/// Change this when making new blocks
	int ChangeID = BlockID + ID_Shrub;
	int ChangeTopID = BlockID + ID_Shrub + 1;
